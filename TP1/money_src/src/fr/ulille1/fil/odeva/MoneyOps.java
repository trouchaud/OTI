...
public class MoneyOps {
   ...
   */
  public static Money simpleSub(Money m1, Money m2) throws IncompatibleCurrencyException, UnexistingCurrencyException, NegativeResultException {

    if (m1.getValue() < m2.getValue())
      throw new NegativeResultException(m1,m2);
      Money m = mf.createMoney(m1.getValue() - m2.getValue(), m1.getCurrency());
      return m;
    }
  }
